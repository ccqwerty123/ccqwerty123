...
# =================================================================
#  一键安装并运行Google Chrome的终极健壮脚本 (V11 - 智能端口与错误处理)
# =================================================================
#
# 版本: 11.0
# 更新日期: 2025-07-15
...
# 例如，设置为 1 将使用显示器 :1 和 VNC 端口 5901。
DISPLAY_NUM=1
...
if ! command -v x11vnc &> /dev/null || ! command -v websockify &> /dev/null; then
    ...
    # xdpyinfo 包含在 x11-utils 中，用于后续检查
...
# 等待最多5秒，使用xdpyinfo检查X server是否响应，这比sleep更可靠
